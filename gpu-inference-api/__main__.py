...
launch_template = aws.ec2.LaunchTemplate(
    ...
    instance_type="g4dn.xlarge",  # 1 GPU, 4 vCPUs, 16 GB RAM
    ...
    block_device_mappings=[
        aws.ec2.LaunchTemplateBlockDeviceMappingArgs(
            ...
            ebs=aws.ec2.LaunchTemplateBlockDeviceMappingEbsArgs(
                volume_size=100,  # Larger volume for models
                volume_type="gp3",
...
pulumi.export(
    "api_endpoint",
    alb.dns_name.apply(lambda dns: f"http://{dns}"),
)
